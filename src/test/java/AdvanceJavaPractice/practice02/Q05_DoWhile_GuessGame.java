       ...
       //  System.out.println("randomNumber = " + randomNumber);
        ...
        do {
            ...
            if (number < randomNumber){
                ...
                System.out.println("You found the number in "+(10-numOfAttempts)+ " attempt(s)");
                System.out.println("You scored: "+(numOfAttempts + 1)*10 + " points!"); // 1st guess => 100 points; 2nd guess => 90
                break;
            }
